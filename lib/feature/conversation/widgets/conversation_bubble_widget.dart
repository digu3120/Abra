                                                                  ...
                                                                  child: Hero(
                                                                    ...
                                                                    child: Stack(
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                              decoration: BoxDecoration(color: Colors.black.withOpacity(0.6), borderRadius: BorderRadius.circular(Dimensions.radiusLarge))),
                                                                          Positioned.fill(
                                                                              child: Center(
                                                                            child:
                                                                                Text(
                                                                              ...
                                                                              Expanded(
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Text("${fileList[index].filSize}", style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor)),
                                                                                  ],
                                                                                ),
                                                                              )
                                                                            ],
