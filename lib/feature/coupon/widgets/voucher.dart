...
class Voucher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isCouponAvailableInCart =
        Get.find<CartController>().cartList.isNotEmpty &&
            Get.find<CartController>().cartList.first.couponCode != null;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        couponController.isLoading &&
                            ...
                            : InkWell(
                                onTap: isCouponAvailableInCart &&
                                        couponModel.isUsed == 0
                                    ? () {
