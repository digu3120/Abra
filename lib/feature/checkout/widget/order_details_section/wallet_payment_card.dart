...
class WalletPaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CartController>(builder: (cartController) {
      ...
      double bookingAmount = fromPage == "custom-checkout"
                        ...
                        children: [
                          Row(children: [
                            ...
                            if (cartController.walletPaymentStatus &&
                                !isPartialPayment)
                              Text(
                                "${'remaining'.tr} ${PriceConverter.convertPrice(remainingWalletBalance)}",
                      ...
                      ? TextButton(
                          onPressed: () {
                            ...
                            Get.find<CheckOutController>()
                                .getPaymentMethodList(shouldUpdate: true);
